...
next=chrome_browser.find_element_by_xpath('//*[@id="identifierNext"]/div/button/div[2]')
next.click()
time.sleep(5)
...
next2=chrome_browser.find_element_by_xpath('//*[@id="passwordNext"]/div/button/div[2]')
next2.click()
...
copy1=chrome_browser.find_element_by_xpath('//*[@id="qSbE9"]/div/div[2]/div[3]/div/span/span/span[2]')
copy1.click()
